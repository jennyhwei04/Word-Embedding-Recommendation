...
class metapathGeneration:
    def __init__(self, unum, bnum):
        self.unum = unum + 1
        self.bnum = bnum + 1
        #self.conum = conum + 1
        #self.canum = canum + 1
        #self.cinum = cinum + 1
        ub = self.load_ub('../data/ub_1.0.train')
        self.get_UBU(ub, '../data/metapath/ubu_1.0.txt')
        #self.get_UBCaBU(ub, '../data/bca.txt', '../data/metapath/ubcabu_0.8.txt')
      #  self.get_UBCiBU(ub, '../data/bci.txt', '../data/metapath/ubcibu_0.8.txt')
        self.get_BUB(ub, '../data/metapath/bub_1.0.txt')
...
if __name__ == '__main__':
    #see __init__() 
    metapathGeneration(unum=41, bnum=97)
