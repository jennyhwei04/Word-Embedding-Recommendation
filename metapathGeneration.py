...
class metapathGeneration:
    def __init__(self, unum, bnum, canum):
        self.unum = unum + 1
        self.bnum = bnum + 1
        #self.conum = conum + 1
        self.canum = canum + 1
        #self.cinum = cinum + 1
        ub = self.load_ub('../data/ub_0.6.train')
        self.get_UBU(ub, '../data/metapath/ubu_0.6.txt')
        self.get_UBCaBU(ub, '../data/bca.txt', '../data/metapath/ubcabu_0.6.txt')
      #  self.get_UBCiBU(ub, '../data/bci.txt', '../data/metapath/ubcibu_0.8.txt')
        self.get_BUB(ub, '../data/metapath/bub_0.6.txt')
       # self.get_BCiB('../data/bci.txt', '../data/metapath/bcib_0.8.txt')
        self.get_BCaB('../data/bca.txt', '../data/metapath/bcab_0.6.txt')
...
if __name__ == '__main__':
    #see __init__() 
    metapathGeneration(unum=41, bnum=97, canum=29)
