...
array =np.zeros(97)
arrays = np.zeros(97)
array_ori = np.zeros(97)
arrays_ori=np.zeros(97)
m = np.zeros((41,97))
#print(key)
#print(key_)
for i in range(41):
...
class HNERec:
    ...
    def recommend(self):
        ...
        print ('MAE: ', np.mean(mae), ' RMSE: ', np.mean(rmse))
...
if __name__ == "__main__":
    ...
    userdim = 10
    itemdim = 10
    train_rate = 0.2#float(sys.argv[1])
...
'''
    ...
    precision=0
    counter = 0
    counter1 = np.zeros(41)
    for i in range(len(R_test)):
        if R_test[i][0] is key:
            #print(R_test[i][0])
            counter  += 1
...
from sklearn.metrics import mean_squared_error
from sklearn.metrics import mean_absolute_error
print("user_mae:",mean_absolute_error(array,array_ori))
print("user_rmse:",np.sqrt(mean_squared_error(array,array_ori)))
#print("user_rmse:",np.sqrt(mean_squared_error(array,array_ori))
print("item_mae:",mean_absolute_error(arrays,arrays_ori))
print("item_rmse:",np.sqrt(mean_squared_error(arrays,arrays_ori)))
    #print(recall)
    #print(precision)
    #recall = hit/(139 *1.00)
    #precision = hit/(len(q1)*30*1.00)#train rate = 0.8
    #print("userCF_recall:",recall)
   # print("userCF_precision:",precision)
    ...
    #for i in range(len(q)):
       # if q[i] in user:
        ...
        #recall += len(user)
       # precision += dis
   # recall = hit/(recall*1.00)
   # precision = hit/(precision*1.00)
   # print("userCF:",recall)
   # print("userCF:",precision)
